...
context('Cookies', () => {
  ...
  it('cy.getCookies() - get browser cookies for the current domain', () => {
    ...
    cy.getCookies().should('have.length', 1).should((cookiez) => {
      const [cookies] = cookiez
      // each cookie has these properties
      expect(cookies).to.have.property('name', 'token')
      expect(cookies).to.have.property('value', '123ABC')
      expect(cookies).to.have.property('httpOnly', false)
      expect(cookies).to.have.property('secure', false)
